...
import { InspectionsRRHHService, type InspectionRRHH } from '@/lib/services/inspections-rrhh.service'
import RRHHInspectionManager from '../../ui/RRHHInspectionManager'
...
export default function RRHHInspectionByIdPage() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        ...
        const { data, error: loadError } = await InspectionsRRHHService.getInspectionById(inspectionId)
        ...
        const inspection = data as InspectionRRHH

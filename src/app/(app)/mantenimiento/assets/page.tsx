...
export default async function MaintenanceAssetsPage({
  ...
  const canAccessMaintenance = userRole === 'admin' || userAssetCategory === 'MAINTENANCE'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Gestión de Activos - Mantenimiento</h1>
          <p className="text-sm text-gray-600 mt-1">Administra el inventario de equipos de Mantenimiento</p>

                ...
                <p className="text-sm text-gray-500">
                  {course.enrollment?.status === 'completed' ? (
                    ...
                    <>
                      ...
                      {course.modules_with_progress.length} módulos completados
                    </>
                  )}
                </p>
              </div>
                  ...
                  {isExpanded && (
                    <div className="border-t bg-gray-50 p-4">
                      ...
                      {!module.isLocked && module.progress?.status !== 'completed' && (
                        ...
                        >
                          <Play className="w-5 h-5" />
                          {module.progress?.status === 'in_progress' ? 'Continuar módulo' : 'Comenzar módulo'}
                        </button>
                      )}
                    </div>
                  )}
        ...
        <div className="mt-6 bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-xl border border-yellow-200 p-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-bold text-yellow-800">¡Felicidades!</h3>

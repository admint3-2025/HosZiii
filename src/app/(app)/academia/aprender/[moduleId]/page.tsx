  ...
  if (error || !module) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] text-gray-500">
        ...
        <p className="text-lg">{error || 'M+¶dulo no encontrado'}</p>
        <button
          onClick={() => router.back()}
    ...
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          <button
            onClick={() => router.push(`/academia/curso/${module.course_id}`)}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="mt-4 bg-blue-50 rounded-lg border border-blue-200 p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-blue-900">-ÌHas completado todo el contenido!</h3>
                    <p className="text-sm text-blue-700">Ahora puedes realizar la evaluaci+¶n del m+¶dulo.</p>
                  </div>
                </div>
                <button
                  onClick={() => router.push(`/academia/evaluacion/${module.quizzes![0].id}`)}
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-lg border p-4 sticky top-4">
            <h3 className="font-semibold text-gray-900 mb-4">Contenido del m+¶dulo</h3>

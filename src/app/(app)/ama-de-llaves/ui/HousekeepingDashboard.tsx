...
// ──────── Empty state ────────
function EmptyState({ locationName }: {
  locationName: string
}) {
  return (
    <div className="card">
      <div className="card-body p-8 text-center">
        ...
        <p className="text-sm text-slate-500 max-w-md mx-auto mb-4">
          ...
          Accede a <span className="font-semibold">Gestión de Habitaciones</span> para agregar habitaciones manualmente o importar un CSV con la numeración y tipos correctos.
        </p>
      </div>
    </div>
  )

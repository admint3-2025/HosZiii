-- ============================================================================
-- FIX CRÍTICO: PostgreSQL triggers requieren NEW y OLD en MAYÚSCULA
-- ============================================================================

-- PROBLEMA REAL IDENTIFICADO:
-- Múltiples funciones trigger de assets usan "new" y "old" en minúscula
-- PostgreSQL SOLO reconoce NEW y OLD en mayúscula
-- Error: "missing FROM-clause entry for table 'new'"

-- FUNCIONES AFECTADAS:
-- 1. set_asset_location() 
-- 2. log_asset_assignment_change()
-- 3. validate_asset_location_change()

-- ============================================================================
-- 1. Corregir set_asset_location - cambiar "new" por "NEW"
-- ============================================================================
...
-- ============================================================================
-- 2. Re-crear el trigger (por si acaso)
-- ============================================================================
...
-- ============================================================================
-- 3. Corregir log_asset_assignment_change - cambiar "old/new" por "OLD/NEW"
-- ============================================================================
...
-- ============================================================================
-- 4. Corregir validate_asset_location_change - cambiar "old/new" por "OLD/NEW"
-- ============================================================================
...
-- ============================================================================
-- 5. Re-habilitar todos los triggers
-- ============================================================================

ALTER TABLE assets ENABLE TRIGGER ALL;

-- ============================================================================
-- FIN - Ahora SÍ debería funcionar la creación de activos
-- ============================================================================
